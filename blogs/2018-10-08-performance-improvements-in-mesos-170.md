...
url: "/blog/mesos-1-7-0-performance-improvements/"
...
<p>After adapting <code>jsonify</code> to use RapidJSON and eliminating some additional <code>mesos::Resource</code> copying, we ran the master state query benchmark. This benchmark builds up a large simulated cluster in the master and times the end-to-end response time from a client&rsquo;s perspective:</p>

<p><img alt="1.7 RapidJSON" src="/assets/img/blog/1.7-performance-improvements-rapidjson.png" /></p>
...
<p><img alt="1.7 Parallel state serving benchmark" src="/assets/img/blog/1.7-performance-improvements-parallel-state.png" /></p>
...
<p><img alt="1.7 Allocation Cycle Benchmark" src="/assets/img/blog/1.7-performance-improvements-allocation-cycle.png" /></p>
...
<p><img alt="1.7 containers endpoint task counts" src="/assets/img/blog/1.7-performance-improvements-containers-endpoint-tasks.png" /></p>
...
<p><img alt="1.7 containers endpoint latency" src="/assets/img/blog/1.7-performance-improvements-containers-endpoint-latency.png" /></p>
